        ...
        <div className="submission-section w-full my-1.5 box-border">
          {layoutStyle === 'side-by-side' ? (
            <div className="grid grid-cols-2 gap-5 items-stretch">
              ...
              <div className="submitted-by min-w-0 w-full h-full box-border border border-blue-200/90 rounded-xl p-4 bg-white shadow-2xs flex flex-col justify-between">
                <div>
                  <div className="border-b border-blue-200 pb-1.5 mb-2.5">
                    <h4 className="font-sans font-bold text-[15px] text-[#1e3a8a] uppercase tracking-wider">
                      SUBMITTED BY
                    </h4>
                  </div>
                  <div className="space-y-2 font-sans text-[15px] leading-snug">
                    ...
                    <div className="grid grid-cols-[108px_14px_1fr] items-baseline">
                      ...
                      <span className="text-[#64748b] font-bold">:</span>
                      <span className="font-mono font-bold text-[#0f172a] text-[15.5px] break-words min-w-0">
                        {data.student.roll || ''}
                      </span>
                    </div>
                    <div className="grid grid-cols-[108px_14px_1fr] items-baseline">
                      ...
                      <span className="text-[#64748b] font-bold">:</span>
                      <span className="text-[#0f172a] font-medium text-[15px] break-words min-w-0">
              ...
              <div className="submitted-to min-w-0 w-full h-full box-border border border-blue-200/90 rounded-xl p-4 bg-white shadow-2xs flex flex-col justify-between">
                <div>
                  <div className="border-b border-blue-200 pb-1.5 mb-2.5">
                    <h4 className="font-sans font-bold text-[15px] text-[#1e3a8a] uppercase tracking-wider">
                      SUBMITTED TO
                  ...
                  <div className="space-y-2 font-sans text-[15px] leading-snug">
                    ...
                    <div className="grid grid-cols-[108px_14px_1fr] items-baseline">
                      <span className="text-[#475569] font-bold">Department</span>
                      <span className="text-[#64748b] font-bold">:</span>
                      <span className="text-[#0f172a] font-medium text-[15px] leading-snug break-words min-w-0">
                    ...
                    <div className="grid grid-cols-[108px_14px_1fr] items-baseline">
                      ...
                      <span className="text-[#64748b] font-bold">:</span>
                      <span className="text-[#475569] text-[13.5px] break-words min-w-0">
