        ...
        <div className="my-1.5">
          {layoutStyle === 'side-by-side' ? (
            <div className="grid grid-cols-2 gap-5 items-stretch">
              {/* Left: Submitted By */}
              <div className="border border-slate-900/90 rounded-xl p-4.5 bg-white shadow-2xs flex flex-col justify-between h-full min-w-0 w-full box-border">
                <div>
            ...
            <div className="space-y-2.5 max-w-[480px] mx-auto">
              <div className="border border-slate-900 rounded-xl p-3.5 bg-white shadow-2xs">
