      ...
      <div className="my-1.5">
        {layoutStyle === 'side-by-side' ? (
          <div className="grid grid-cols-2 gap-5 items-stretch">
            {/* Left: Submitted By */}
            <div className="border border-slate-900/90 rounded-lg p-3 bg-white/95 shadow-2xs flex flex-col justify-between backdrop-blur-xs h-full min-w-0 w-full box-border">
              <div>
