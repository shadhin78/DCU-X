    ...
    <header className="bg-white border-b border-slate-200 sticky top-0 z-30 px-3.5 sm:px-6 py-3 shadow-xs">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 flex-nowrap justify-between md:justify-end w-full md:w-auto">
          ...
          {/* Download PDF Button (Executes print dialog to save as crisp, native single-page A4 PDF) */}
          <button
            type="button"
            id="btn-download-pdf"
            onClick={onPrint}
            className="flex-[1.2] md:flex-initial inline-flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 text-[11px] sm:text-xs font-bold text-white bg-blue-600 hover:bg-blue-700 active:bg-blue-800 rounded-lg shadow-xs transition-all cursor-pointer shrink-0 whitespace-nowrap"
